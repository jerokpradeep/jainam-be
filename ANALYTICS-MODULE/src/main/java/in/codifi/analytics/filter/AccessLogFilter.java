package in.codifi.analytics.filter;
...
import in.codifi.analytics.entity.logs.AccessLogModel;
import in.codifi.analytics.repository.AccessLogManager;
		...
		pool.execute(new Runnable() {
			...
			public void run() {
				try {
					...
					accLogModel.setModule(AppConstants.MODULE_ANALYTICS);
