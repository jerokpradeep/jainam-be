...
//	public RestResponse<OdinSsoModel> prepareOdinResponse(int code, String message, PlainMessage plainMessage) {
//		OdinSsoModel odinSsoModel = new OdinSsoModel();
//		odinSsoModel.setCode(code);
//		odinSsoModel.setMessage(message);
//		odinSsoModel.setPlainMessage(plainMessage);
//		return RestResponse.ResponseBuilder.create(Status.OK, odinSsoModel).build();
//	}
