package in.codifi.sso.auth.ws.service.spec;
...
public interface KcTokenRestSpec {
	...
	public Response fetchToken(@FormParam("client_id") String client_id,
	...
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	@APIResponse(description = "Fetches access token for user creation")
	public Response fetchAdminToken(@FormParam("client_id") String client_id,
			@FormParam("client_secret") String client_secret, @FormParam("grant_type") String grant_type);
	...
	@Consumes(MediaType.APPLICATION_FORM_URLENCODED)
	@APIResponse(description = "Fetches access token for user creation")
	public Response fetchTokenByRefereshToken(@FormParam("client_id") String client_id,
			@FormParam("client_secret") String client_secret, @FormParam("grant_type") String grant_type,
	...
	public Response getIntroSpect(@FormParam("username") String userId, @FormParam("client_id") String clientId,
			@FormParam("client_secret") String clientSecret, @FormParam("token") String token);
