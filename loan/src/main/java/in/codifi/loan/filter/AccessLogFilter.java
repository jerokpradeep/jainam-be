...
import in.codifi.loan.repository.AccessLogManager;
import in.codifi.loan.utility.AppConstants;
import in.codifi.loan.entity.logs.AccessLogModel;
		...
		pool.execute(new Runnable() {
			...
			public void run() {
				try {
					...
					accLogModel.setModule(AppConstants.MODULE_LOAN);
